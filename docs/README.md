...
This directory contains the versioned source for the complete `monzo-mcp`
documentation. The guides are kept with the code so documentation changes can
be reviewed and released with the behavior they describe.
...
The files under `docs/wiki/` are the canonical guides. Update them in the same
pull request as the behavior they describe. Do not put secrets, account
identifiers, or real transaction data in examples.
