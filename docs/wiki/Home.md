...
Read [Getting Started](Getting-Started.md) to choose a mode and connect a
client.

## Documentation

- [Getting Started](Getting-Started.md)
- [Standalone Local Mode](Standalone-Local-Mode.md)
- [External Broker Mode](External-Broker-Mode.md)
- [Docker Deployment](Docker-Deployment.md)
- [Configuration](Configuration.md)
- [Tools and Data](Tools-and-Data.md)
- [Architecture](Architecture.md)
- [Security](Security.md)
- [Operations](Operations.md)
- [Troubleshooting](Troubleshooting.md)
- [aiomonzo Python Client](Python-Client.md)
